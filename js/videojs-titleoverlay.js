...
/**
 MODIFICADO POR: Guilherme Albuquerque
 PARA: drena.pt
 */
...
(function(factory) {
    ...
    var TitleOverlayPlugin = function(player, options) {
        ...
        var createOverlayContainer_ = function() {
            ...
            this.titleOverlayTextContainer.style.position = "absolute";
            this.titleOverlayTextContainer.style.top = "0";
            ...
            this.titleOverlayTextContainer.style.fontFamily = "MADE TOMMY Regular";
