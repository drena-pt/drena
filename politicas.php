...
?>
	...
	<body>
		...
		<div id="swup" class="transition-fade">
			...
			.jumbotron{
				height: 50vh;
				background-image: linear-gradient(-90deg,rgba(0,0,0,0.6),rgba(0,0,0,0),rgba(0,0,0,0.6)),url("imagens/fundo1.jpg");
            ...
            <div class='jumbotron bg-dark d-flex align-items-center text-center justify-content-center align-items-center'>
                <span><h1 class='display-4'>".mb_strtoupper('Política de Privacidade<br> e Termos de Utilização',mb_internal_encoding())."</h1><br><a href='#' role='button' class='btn btn-primary'>Versão 1.0 - 28 de julho de 2021</a></span>
            </div>
